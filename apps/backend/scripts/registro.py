...
def build_parser() -> argparse.ArgumentParser:
    ...
    d.add_argument("--humor", type=int, required=True, help="1–5")
    d.add_argument("--energia", type=int, required=True, help="1–5")
    d.add_argument("--sono-h", dest="sono_h", required=True, help="horas, ex 7 ou 7.5")
    d.add_argument("--sono-q", dest="sono_q", type=int, required=True, help="qualidade 1–5")
    ...
    pu.add_argument("--humor", type=int, required=True, help="1–5")
    pu.add_argument("--energia", type=int, required=True, help="1–5")
